...
export async function generateStaticParams() {
   ...
   `);
   return data.data.ductAirconds.nodes.map((el: any) => ({
      ...
      <div className={styles.item}>
         ...
         <div className={`container ${styles.item__container}`}>
            ...
            <div className={styles.item__body}>
               <h2 className={styles.item__title}>Канальные кондиционеры</h2>
               {data.data.ductAirconds.nodes.map((el) => {
                     ...
                     if (!flag) {
                        ...
                        return (
                           <div key={el.id} className={`${styles.item__main} ${styles.main}`}>
                              <h3 className={styles.main__title}>Серия канальных кондиционеров {el.semiIndustrialGroup.name}</h3>
